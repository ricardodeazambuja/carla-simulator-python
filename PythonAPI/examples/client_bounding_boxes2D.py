...
import skimage.measure as measure # Used only for get_bbox_from_mask
...
class BasicSynchronousClient(object):
    ...
    def render(self, display):
        ...
        if self.image is not None:
            ...
            self.masked = array.copy()
            mask = self.masked[..., 0] != 142 # this is the color for vehicles (R,G,B) = (142,0,0)
                                              # https://carla.readthedocs.io/en/0.9.12/ref_sensors/#semantic-segmentation-camera
            self.masked[mask] = 0
            self.masked[np.invert(mask)] = 255
    ...
    def game_loop(self):
        ...
        try:
            ...
            while True:
                ...
                ClientSideBoundingBoxes.draw_bounding_boxes(self.display, bboxes2D)

                bboxes2Dfrommask = get_bbox_from_mask(self.masked)
                ClientSideBoundingBoxes.draw_bounding_boxes(self.display, bboxes2Dfrommask, BB_COLOR = (0, 255, 0)) # green bboxes
